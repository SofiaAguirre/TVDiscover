...
class Movies extends Component {
  ...
  componentDidMount() {
    fetch(
      `https://api.themoviedb.org/3/movie/top_rated?api_key=${this.apiKey}&language=en-US`
    )
      .then(data => data.json())
      .then(data => {
        console.log(data);
  ...
  nextPage = (pageNumber) => {
    fetch(
      `https://api.themoviedb.org/3/movie/top_rated?api_key=${this.apiKey}&language=en-US&page=${pageNumber}`
    )
      .then(data => data.json())
      .then(data => {
        console.log(data);
  ...
  render() {
    ...
    return (
      <div className="container">
        <h1 className="title-rated">Top Rated Movies:</h1>
        <div className="row">
