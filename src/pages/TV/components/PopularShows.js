...
class Shows extends Component {
  ...
  componentDidMount() {
    fetch(
      `https://api.themoviedb.org/3/tv/popular?api_key=${this.apiKey}&language=en-US`
    )
      .then(data => data.json())
      .then(data => {
        console.log(data);
  ...
  nextPage = (pageNumber) => {
    fetch(
      `https://api.themoviedb.org/3/tv/popular?api_key=${this.apiKey}&language=en-US&page=${pageNumber}`
    )
      .then(data => data.json())
      .then(data => {
        console.log(data);
  ...
  render() {
    ...
    return (
      <div className="container">
        <h1 className="title-rated">Popular Shows:</h1>
        <div className="row">
